...
function adicionarUsuario() {
    ...
    fetch('https://projeto-integrador-planeje-e-estude.onrender.com/signup', {
      method: 'POST',
      headers: {
  ...
  async function loginUsuario() {
    ...
    try {
      const resposta = await fetch('https://projeto-integrador-planeje-e-estude.onrender.com/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
